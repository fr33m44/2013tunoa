...
$.fn.simpleTree = function(opt){
	return this.each(function(){
		...
		TREE.setTreeNodes = function(obj, useParent){
			...
			.bind('selectstart', function() {
				...
				if(TREE.option.drag)
				{
					...
					$("<img>").attr({id	: "tree_plus",src	: treePrePath+"js/tree/stree/images/plus.gif"}).css({width: "7px",display: "block",position: "absolute",left	: "5px",top: "5px", display:'none'}).appendTo("body");
		...
		TREE.setTrigger = function(node){
			$('>span',node).before('<img class="trigger" src="'+treePrePath+'js/tree/stree/images/spacer.gif" border=0>');
		...
		TREE.dragStart = function(event){
			...
			if(mousePressed)
			{
				...
				if(event.target.tagName.toLowerCase()=='span' && $.inArray(event.target.className, Array('text','active','trigger'))!= -1)
				{
					...
					{
						if(isrc.indexOf('minus')!=-1)$("#tree_plus").attr('src',treePrePath+'js/tree/stree/images/plus.gif');
					...
					{
						mouseMoved = false;
						$("#tree_plus").attr('src',treePrePath+'js/tree/stree/images/minus.gif');
						$("#tree_plus").css({"left": screenScroll.x, "top": screenScroll.y}).show();
						...
						*/
						TREE.setAjaxNodes(ajaxChild,parent.id, function(){
							parent.className = parent.className.replace('close','open');
							mouseMoved = true;
							$("#tree_plus").attr('src',treePrePath+'js/tree/stree/images/plus.gif');
							$("#tree_plus").css({"left": screenScroll.x, "top": screenScroll.y}).show();
						});
