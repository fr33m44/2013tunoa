...
function TabView(option) {
	...
	if($("#scrollContent").attr("childScrollContent")=="true"){
		page= '<iframe id="{0}" scrolling="no" allowTransparency="true" frameborder="0" width="100%" height="100%" src="{1}"></iframe>';
	}
	else{
		page= '<iframe id="{0}" style="overflow-x:hidden;" allowTransparency="true" frameborder="0" width="100%" height="100%" src="{1}"></iframe>';
	}
