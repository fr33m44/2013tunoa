...
function Keypad() {
	...
	this.regional[''] = { // Default regional settings
		...
		buttonStatus: '打开键盘', // Status text for trigger button
		closeText: '关闭', // Display text for close link
		closeStatus: '关闭键盘', // Status text for close link
		clearText: '清空', // Display text for clear link
		clearStatus: '清空所有文字', // Status text for clear link
		backText: '回删', // Display text for back link
		backStatus: '删除最后一个字', // Status text for back link
		enterText: 'Enter', // Display text for carriage return
		enterStatus: '', // Status text for carriage return
		shiftText: 'Shift', // Display text for shift link
		shiftStatus: '切换大小写', // Status text for shift link
...
$(function(){
	$(".keypad").each(function(){
		if($(this).attr("mode")=="full"){
			$(this).keypad({ keypadOnly: false, layout: $.keypad.qwertyLayout, prompt: ''});
		}
		else{
			$(this).keypad();
		}
